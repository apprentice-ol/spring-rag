 ...
 *
 * <p><b>职责</b>：slf4j 委托（自动带 MDC traceId/spanId）；{@link #event}（经 {@link Telemetry#emit} → sink 链）；{@link #conversationOutput}/{@link #conversationSink}（对话级 trace output）。</p>
 *
 * <p><b>协作</b>：通过 {@link Telemetry#getInstance()} 静态委托（Spring 启动后非空）。</p>
 *
 * <p><b>用法</b>：
 * <pre>{@code
