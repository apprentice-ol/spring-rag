 ...
 *
 * <p><b>协作</b>：span 名 = {@code @ObservedStep.value()}（若 target 有 {@code getName()} 则展开为 {@code value.getName}）；{@code kind=ROOT} 走 {@link ObsTemplate#openTrace}，默认 STEP 走 {@link ObsTemplate#openStep}；流式经 {@link ObsTemplate#decorateFlux}。</p>
 *
