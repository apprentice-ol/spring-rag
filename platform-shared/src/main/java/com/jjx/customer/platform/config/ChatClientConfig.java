 ...
 *
 * @see com.jjx.customer.platform.knowledge.retrieval.MultiChannelRetrievalEngine
 * @see com.jjx.customer.platform.business.orchestration.ChatOrchestrator
 */
@Configuration
public class ChatClientConfig {
    ...
    /**
     * 流式回答落库执行器（虚拟线程）。
     * <p>ChatOrchestrator 的 complete/error 回调运行在 WebClient 的 reactor-http-nio 事件循环线程上，
