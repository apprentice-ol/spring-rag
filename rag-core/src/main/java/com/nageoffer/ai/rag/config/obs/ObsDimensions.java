package com.nageoffer.ai.rag.config.obs;
 ...
 *
 * <p>触发点：被 {@code @ObservedStep} 标注的方法（或 {@code ObsTemplate.step}）返回时，
 * obs 按{@link ObsTemplate#dimensionOnOutput}注册表匹配类型并提取。</p>
 */
@Configuration
public class ObsDimensions {

    public ObsDimensions(ObsTemplate obsTemplate) {
