...
public class BlockSanitizer {
    ...
    public SanitizeResult sanitize(List<Block> blocks) {
        ...
        for (Block block : blocks) {
            ...
            if (block instanceof com.jjx.customer.platform.ingestion.engine.parser.model.ListBlock l
                    && l.items() != null) {
                List<String> items = l.items().stream()
                        ...
                        .toList();
                if (!items.isEmpty()) {
                    cleaned.add(new com.jjx.customer.platform.ingestion.engine.parser.model.ListBlock(
            ...
            if (block instanceof com.jjx.customer.platform.ingestion.engine.parser.model.CodeBlock c
                    && c.code() != null) {
                ...
                cleaned.add(new com.jjx.customer.platform.ingestion.engine.parser.model.CodeBlock(
