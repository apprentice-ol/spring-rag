package com.jjx.customer.platform.ingestion.controller;
...
import com.jjx.customer.platform.ingestion.mapper.IngestionTaskMapper;
import com.jjx.customer.platform.ingestion.mq.IngestionMessage;
import com.jjx.customer.platform.ingestion.mq.IngestionProducer;
import com.jjx.customer.platform.ingestion.service.IngestionResult;
import com.jjx.customer.platform.ingestion.service.IngestionService;
import com.jjx.customer.platform.storage.client.ObjectStorageClient;
import com.jjx.customer.platform.storage.service.impl.LocalFileStorageService;
...
public class IngestionController {
    ...
    private String resolveSourceKey(String location) {
        try {
            ...
            String path = uri.getPath(); // /customer-platform-kb/{docId}/{hash}.md
