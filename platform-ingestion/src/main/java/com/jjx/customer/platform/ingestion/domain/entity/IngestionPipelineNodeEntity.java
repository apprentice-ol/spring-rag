package com.jjx.customer.platform.ingestion.domain.entity;
 ...
 * 可用的节点类型由 {@link com.jjx.customer.platform.ingestion.domain.enums.NodeType} 枚举定义。
 * </p>
 *
 * @see IngestionPipelineEntity 所属流水线
 * @see com.jjx.customer.platform.ingestion.engine.node.IngestionNode 节点执行逻辑接口
 * @see com.jjx.customer.platform.ingestion.engine.ConditionEvaluator 条件评估器
 */
@Data
